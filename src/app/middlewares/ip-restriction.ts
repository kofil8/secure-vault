...
const allowedIps = [
  "123.09.23.2", // Replace with your real NordVPN dedicated IP
];
...
export const restrictToDedicatedIP = (req: Request, res: Response, next: NextFunction) => {
  ...
  return res.status(403).json({
    message: "Access restricted. Please connect using the authorized NordVPN IP."
  });
};
